...
class APITester:
    ...
    def test(self, name, method, url, data=None, headers=None, expected_status=[200, 201, 204]):
    ...
    def test_authentication(self):
        ...
        self.test("Registrar Comprador", "POST", f"{BASE_URL}/api/v1/auth/register/", buyer_data)
        ...
        self.test("Registrar Vendedor", "POST", f"{BASE_URL}/api/v1/auth/register/", seller_data)
    ...
    def test_products(self):
        ...
        # Buscar produtos
        self.test("Buscar Produtos", "GET", f"{BASE_URL}/api/v1/products/search/?query=test")
    ...
    def test_orders(self):
        ...
        if not self.buyer_token or not self.cart_code:
            self.log("Pulando testes de pedidos - requisitos não atendidos", Colors.YELLOW)
            return
    ...
    def test_reviews(self):
        ...
        if not self.buyer_token or not self.product_id:
            self.log("Pulando testes de reviews - requisitos não atendidos", Colors.YELLOW)
            return
    ...
    def test_wishlist(self):
        ...
        if not self.buyer_token or not self.product_id:
            self.log("Pulando testes de wishlist - requisitos não atendidos", Colors.YELLOW)
            return
    ...
    def print_report(self):
        ...
        if self.failed > 0:
            ...
            self.log("  - O servidor está rodando (python manage.py runserver)", Colors.YELLOW)
